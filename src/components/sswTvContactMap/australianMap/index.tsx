...
import FiestaImg from "../../../assets/images/placeholder.png"
...
const MapAustralia = () => {
    ...
    return(
        <article className=' col-sm-6 hidden-xs'>
            <div id='mapWrap'>
                <div className="select-nsw" id='locationMap'>
                <img src={FiestaImg} alt="" width={402} height={350} useMap='#map' id='map-img'/>
