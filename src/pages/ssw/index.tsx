                ...
                >
                    <div>
                        ...
                        <p>
                            ...
                            software and web development experience. We build on
                            top of Angular, React, Vue, Azure, Azure DevOps (was
                            TFS), SharePoint, Office 365, Blazor, .NET, WebAPI,
                    ...
                    <div className="row">
                        ...
                        <div className="col-sm-7">
                            ...
                            <p>
                                ...
                                <b>Cloud Platform</b>, <b>DevOps</b>; and silver
                                in Collaboration and Content, and Data
                                Analytics.
                            </p>
                        </div>
                        <div className="col-sm-5">
                        ...
                        <div className="col-sm-7">
                            <p>
                                We are proud to announce we have won the MAPA -
                                Microsoft Australia Partner Award - for
                                Excellence in Learning for{' '}
                                <a href="https://www.firebootcamp.com">
                                    SSW FireBootCamp
                                </a>
                                .
                                ...
                                customer solutions built on the Microsoft
                                platform.
                            </p>
                        </div>
                        <div>
                            ...
                            <p>
                                China is a booming market and now is the time to
                                take advantage of this growing user base. If you
                                have a successful application that you would
                                like to bring to the Chinese market, then
                                working with SSW can help streamline your entry
                                into this market.
                            </p>
                        </div>
                    </div>
