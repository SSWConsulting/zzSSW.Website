    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.contacts}>
                ...
                <a
                    className={classNames(styles.iconContainer, styles.youtube)}
                ...
                <a
                    className={classNames(styles.iconContainer, styles.twitter)}
                ...
                <a
                    className={classNames(styles.iconContainer, styles.wechat)}
                    title="SSW on WeChat"
